...
export const DAILY_ZEX_PERIOD_MS = 24 * 60 * 60 * 1000; // claim'den sonra 24 saat kilit

// Bir günün ms karşılığı
export const DAY_MS = 24 * 60 * 60 * 1000;
// UTC gün numarası. Gün sınırı 00:00 UTC = 03:00 TRT (Türkiye sabit UTC+3).
// Check-in ve günlük ücretsiz egg bu sınıra göre sıfırlanır.
export const utcDayIndex = (ms = Date.now()) => Math.floor(ms / DAY_MS);
